...
1.  La tabla mostrada contiene valores de población, en cientos de
    ...
    1967: Argentina EE. UU. Holanda Japón 29.66 77.81 8.68 110.21 7.61
    35.50 7.31 32.14 6.35 24.79 6.02 18.88 4.10 20.02 2.64 16.38 3.80
    16.70 1.75 13.37 2.75 9.39 1.72 11.92 2.70 9.38 1.51 10.71 2.69 8.76
    1.42 7.80 2.51 7.63 1.31 7.70 2.44 7.50 1.29 7.00
...
```
    ...
    R/ a.Se puede identifacar que 3 de las 4 graficas cuentan con una simettria
    ...
    que no muestra ese comportamiento, ya que en este se observa una
    simetria normal, ademas se identifica que las poblaciones de las
    ciudades de Japon, EEUU y Argentina cuentan con datos atipicos, para ser
    mas especifico uno por cada pais de los .
