...
print(paste("El porcentaje de que las botellas que las personas que llegan 
 embarque puedan tener su silla asegurada y no se presenten 
 quejas por sobre-vender sillas ante la aeronáutica civil es de: ",resp_pois*100,'%'));
```
...
print(paste("El porcentaje de que las botellas que son declaradas producto 
 NO CONFORME es de: ",res*100,'%'))
